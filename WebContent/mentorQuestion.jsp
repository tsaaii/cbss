            ...
            <center>
		            ...
		            <table  width="50%" cellpadding="3">      
		                ...
		                <tbody>
		                    <tr>
		                    <br>  
		                        <td><input type="radio" name="action" value="math"></td>
		                        <td>math</td>
		                    </tr>
		                    <tr>
		                        
		                        <td><input type="radio" name="action" value="socialscience"></td>
		                        <td>socialscience</td>
		                    </tr>
		                    
		                    <tr>
		                       
		                        <td><input type="radio" name="action" value="art"></td>
		                         <td>art</td>
		                    </tr>    
		                    <tr>
		                        
		                        <td><input type="radio" name="action" value="science"></td>
		                        <td>science</td>
		                    </tr>  
		                    <tr>
		                        
		                        <td><input type="radio" name="action" value="religious"></td>
		                        <td>religious</td>
		                    </tr>
